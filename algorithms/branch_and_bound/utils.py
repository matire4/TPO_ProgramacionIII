# ============================================================
# Nut Sort - Complementos y Utilidades para Branch and Bound
# ============================================================
# Este archivo contiene:
# - Funciones de visualización y utilidades
# - Generación de casos aleatorios (reutiliza de backtracking)
...
# Importar el algoritmo de Branch and Bound desde el módulo core
from core import (
    State, Pile, Color, MAX_CAP,
    solve_branch_and_bound, SearchStats,
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("EJEMPLO DE USO DEL ALGORITMO DE BRANCH AND BOUND")
    print("=" * 60)
    ...
    path, stats = solve_branch_and_bound(start_img_like, max_expansions=500000)
    ...
    print(f"  Nodos podados: {stats.pruned}")
    print(f"  Mejor cota encontrada: {stats.mejor_cota_encontrada}")
